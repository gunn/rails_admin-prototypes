...
Currently this project consists of some mouckps in 'mockups', the source files in 'fireworks_pngs' and a site runnable by middleman[https://github.com/tdreyno/middleman].

Please fork and improve!

== The new look
link:https://github.com/gunn/rails_admin-prototypes/mockups/main.png

== In detail
link:https://github.com/gunn/rails_admin-prototypes/mockups/main_with_highlights.png
...
== A login page
link:https://github.com/gunn/rails_admin-prototypes/mockups/login.png

== Nav links in sidebar
link:https://github.com/gunn/rails_admin-prototypes/mockups/nav_in_sidebar.png
...
== Error flash message
link:https://github.com/gunn/rails_admin-prototypes/mockups/error.png

== Error inline
link:https://github.com/gunn/rails_admin-prototypes/mockups/error_inline.png

Compact, but might be a mistake if we ever wanted to show more than one flash message at a time.

== Error above
link:https://github.com/gunn/rails_admin-prototypes/mockups/error_above.png

== Dark header
link:https://github.com/gunn/rails_admin-prototypes/mockups/dark_header.png

Alternative style.

== Dark with high_buttons
link:https://github.com/gunn/rails_admin-prototypes/mockups/dark_header_high_buttons.png

== Dark with darkened buttons
link:https://github.com/gunn/rails_admin-prototypes/mockups/dark_header_dark_buttons.png
